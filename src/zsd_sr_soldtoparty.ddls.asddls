...
@EndUserText.label: 'ZSD_SR_soldtoParty'
...
define view entity ZSD_SR_soldtoParty as select from I_BillingDocumentPartner as a 
...
{ key a.BillingDocument,
  key a.Customer,
  key a.AddressID,
concat(b.OrganizationName1,concat( b.OrganizationName2 ,concat( b.OrganizationName3,b.OrganizationName3  ))) as SOLDToParty,
